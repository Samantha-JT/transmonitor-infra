...
FUNCTIONS=(feed-digest ai-insights trans-rights youtube-proxy feed-ingestor health rss-proxy youtube-live youtube-latest news-digest sentiment-stats tmm-data media-bias news_extra)
